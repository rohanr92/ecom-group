      ...
      <main className="flex-1">
        ...
        <div className="max-container" style={{ padding: 'clamp(40px,6vw,80px) clamp(16px,4vw,60px)', maxWidth: '800px' }}>
          ...
          {[
            ...
            { title: 'Contact Us', body: 'If you experience any accessibility barriers on our website, please contact us at support@solomonlawrencegroup.com. We\'ll respond within 2 business days and work to provide the information you need in an accessible format.' },
          ].map((s, i) => (
