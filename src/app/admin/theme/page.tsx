...
export default function ThemePage() {
  ...
  const [promoMiddle,  setPromoMiddle]  = useState('GET $50 TOWARD A FUTURE PURCHASE WHEN YOU SPEND $150')
  ...
  const [heroTopLabel,     setHeroTopLabel]     = useState('Shop Shoes')
  const [heroTopHref,      setHeroTopHref]      = useState('/collections/shoes')
