  ...
  return (
    <div style={{ maxWidth: '720px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: '32px', paddingBottom: '40px', borderBottom: '1px solid #e8e4de', marginBottom: '40px' }}>
        {[
          { label: 'Email', value: 'support@solomonlawrence.com' },
          { label: 'Hours', value: 'Mon–Fri, 9am–6pm PST' },
          { label: 'HQ', value: 'Los Angeles, California' },
          { label: 'Returns', value: 'returns@solomonlawrence.com' },
        ].map((item, i) => (
          <div key={i}>
      ...
      <p style={{ fontFamily: 'var(--font-body)', fontSize: '13px', color: 'var(--color-mid)', lineHeight: 1.8 }}>
        For press inquiries, contact <a href="mailto:press@solomonlawrence.com" style={{ color: 'var(--color-charcoal)', textDecoration: 'underline' }}>press@solomonlawrence.com</a>. For wholesale or retail partnership inquiries, contact <a href="mailto:wholesale@solomonlawrence.com" style={{ color: 'var(--color-charcoal)', textDecoration: 'underline' }}>wholesale@solomonlawrence.com</a>.
      </p>
    </div>
  )
}