...
const FAQS = [
  { section: 'Orders & Payment', items: [
    ...
    { q: 'Can I modify or cancel my order?', a: 'Orders can be modified or cancelled within 1 hour of placement. Contact us immediately at support@solomonlawrence.com — after 1 hour your order enters fulfillment and cannot be changed.' },
