  ...
  return (
    <div style={{ maxWidth: '720px' }}>
      <p style={{ fontFamily: 'var(--font-body)', fontSize: '14px', color: 'var(--color-mid)', lineHeight: 1.9, marginBottom: '48px' }}>
        We believe fashion and responsibility aren't mutually exclusive. Solomon Lawrence is committed to building a business that's good for people and the planet — not as a marketing exercise, but as a core part of how we operate.
      </p>
      {[
        ...
        { label: 'Circular Fashion', text: 'Our take-back program lets you return worn Solomon Lawrence pieces for store credit. We repair, donate, or responsibly recycle everything returned.' },
      ].map((item, i, arr) => (
