...
export default function TermsFallback() {
  return (
    <div style={{ maxWidth: '720px' }}>
      {[
        { t: '1. Acceptance of Terms', b: 'By using the Solomon Lawrence website and services, you agree to these Terms of Service. If you do not agree, please do not use our website.' },
        ...
        { t: '5. Intellectual Property', b: 'All content on this website — text, images, logos, and software — is the property of Solomon Lawrence Group LLC and is protected by copyright and trademark law.' },
        ...
        { t: '7. Contact', b: 'For questions about these terms, email legal@solomonlawrence.com.' },
      ].map((s, i, arr) => (
